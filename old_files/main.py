...
class ExampleApp(QtWidgets.QMainWindow, ui.Ui_MainWindow):
    ...
    def save_workers_click(self):
        ...
        for row in range(row_pos):
            ...
            for col in range(5):
                try:
                    data.append(self.workers_table.item(row, col).text())
                except AttributeError:
                    pass
            if self.worker_len > row:
                # dbm.update_workers(data[row]) команда
                pass
            else:
        ...
        #     print(col)
        #     try:
        #         print(self.workers_table.item(row_pos, col).text())
        #         data.append(self.workers_table.item(row_pos, col).text())
        #     except AttributeError as e:
        #         print(e)
        #         pass
        # print(data)

        # db.api.add_user(*data)
