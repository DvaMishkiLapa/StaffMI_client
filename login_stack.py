...
"font-weight: bold;")
        ...
        self.label_log_replogin = QtWidgets.QLabel(self.page_replace_login)
        self.label_log_replogin.setEnabled(True)
        self.label_log_replogin.setStyleSheet("color: rgb(255, 0, 0);\n"
"font-weight: bold;")
        self.label_log_replogin.setText("")
        self.label_log_replogin.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_log_replogin.setObjectName("label_log_replogin")
        self.gridLayout_7.addWidget(self.label_log_replogin, 10, 0, 1, 2)
