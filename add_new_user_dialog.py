...
class Ui_add_new_user_dialog(object):
    def setupUi(self, add_new_user_dialog):
        ...
        self.labe_error = QtWidgets.QLabel(add_new_user_dialog)
        self.labe_error.setText("")
        self.labe_error.setObjectName("labe_error")
        self.gridLayout.addWidget(self.labe_error, 4, 0, 1, 3)
    ...
    def retranslateUi(self, add_new_user_dialog):
        ...
        self.label_dialog_newuser.setText(_translate("add_new_user_dialog", "Введите данные"))
